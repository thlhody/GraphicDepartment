...
public class SQLQueries {
    ...
    public static final String GET_MONTHLY_WORK_HOURS_USER =
            "SELECT * FROM work_interval WHERE user_id = ? AND MONTH(first_start_time) = MONTH(CURRENT_DATE()) " +
                    "AND YEAR(first_start_time) = YEAR(CURRENT_DATE()) ORDER BY first_start_time DESC";
